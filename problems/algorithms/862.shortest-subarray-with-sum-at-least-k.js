...
write('algorithms: 862. 和至少为 K 的最短子数组', 'title')

write(shortestSubarray([1], 1)) // 1
write(shortestSubarray([1, 2], 4)) // -1
write(shortestSubarray([2, -1, 2], 3)) // 3
write(shortestSubarray([1, 3, 3, 10, 5, 1, -1, 2, 9], 15)) // 2
