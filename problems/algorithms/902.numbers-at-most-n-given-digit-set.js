...
write('algorithms: 902. 最大为 N 的数字组合', 'title')

write(atMostNGivenDigitSet(['1', '3', '5', '7'], 100)) // 20
write(atMostNGivenDigitSet(['1', '4', '9'], 1000000000)) // 29523
write(atMostNGivenDigitSet(['7'], 8)) // 1
